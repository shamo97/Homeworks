window.onload = function () {
    function s() {
        ...
        function update() {
            ...
            let Text1 = "Highscore  " + menu.magalikula;
            newCanvas.ctx.fillText(Text, 10, 30, 60, 60);
            newCanvas.ctx.fillText(Text1, 250, 30, 90, 90);
